...
function EmptyLeaderboard() {
  return (
    <div className="text-center py-12 fade-in">
      ...
      <h3 className="text-display-sm text-white mb-2">No rankings yet</h3>
    ...
    <Page variant="dark">
      <div className="container-md py-8 space-y-6">
        ...
        {isLoading ? (
          ...
          <div className="divide-y divide-white/5 fade-in">
            {leaderboard.map((entry, index) => (
              <div
                key={entry.nickname}
                className={cn(
                  "py-4 flex items-center gap-4 transition-colors",
                  entry.rank <= 3 && "bg-white/5 -mx-4 px-4 rounded-lg"
                )}
        ...
        {user && (
          <div className="p-5 text-center rounded-lg bg-gradient-to-r from-white/5 to-transparent border border-white/5 fade-in">
