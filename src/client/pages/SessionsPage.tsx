      ...
      <div className="container-lg">
        ...
        <section className="fade-in pt-6">
          <div className="flex items-center justify-between py-4">
            <div>
              <h1 className="text-display-sm text-white">Focus Sessions</h1>
              <p className="text-white/50 text-sm mt-1">Join a session and focus together</p>
            </div>
            <div className="flex items-center gap-3">
              <Link to="/my-sessions" className="btn-outline-light text-sm px-3 py-1.5">
                My Sessions
              </Link>
